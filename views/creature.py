...
class CreatureView(BaseView):
  ...
  def _create_widgets(self):
    ...
    self._xpLabel      = Label(self._infoFrame, text = CreatureView.XP_FMT.format(BaseView.DEFAULT))
    ...
    self._hdLabel      = Label(self._infoFrame, text = CreatureView.HD_FMT.format(BaseView.DEFAULT))
    self._acLabel      = Label(self._infoFrame, text = CreatureView.AC_FMT.format(BaseView.DEFAULT))
    self._hpLabel      = Label(self._infoFrame, text = CreatureView.HP_FMT.format(BaseView.DEFAULT))
